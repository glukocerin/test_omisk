    ...
    cards: [
      {
        ...
        index: "lockdown",
        text:
          "2020. november 11-től iskolánkban is áttértünk az online oktatásra. Ennek részleteiről minden növendékünket e-mailben tájékoztatjuk ezen a héten.[space]Várjuk azokat a növendékeinket is akik a vírusveszély miatt ebben az évben nem kezdtek el járni. Ők régi csoportjukhoz kapcsolódhatnak.[space]Külső jelentkezést is elfogadunk, de ebben az esetben egyeztetni kell Mikusik Márta iskolatitkárral, hogy melyik csoport volna megfelelő.[space]Elérhetőségeink:[space]06-20-946-0848, 06-1-200-0138[space]iroda@omisk.hu[space]Bízunk benne, hogy hamarosan személyesen is találkozhatunk![space]Pers Júlia[space]művészeti vezető",
      },
      {
        ...
        index: "berczik",
        text:
          "Az OMISK-ot ezelőtt 30 évvel azért alapítottuk, hogy a Berczik technikát tanítsuk gyerekeknek. Ahogy tanítványaink  nőttek, velük együtt fejlődött  az iskola is. Sok más műfaj is helyet kapott, de ma is a Berczik-technikát tartjuk a legfontosabb kiindulási pontnak. Az OMISK-ba jelentkező óvodások most is ezzel kezdenek nálunk.[space]A gyermek életének alapeleme a mozgás. Önként és örömmel csinál mindent, ami közel áll természetes mozgás igényéhez és ez megalapozza szellemi-fizikai fejlődését.  A Berczik módszer ebből az ösztönös mozgásból indul ki és alakítja tudatossá. Így az órai gyakorlatok mindig az életkornak megfelelőek, a tudatosság pedig biztos alapokra helyez bármilyen későbbi mozgástanulást.[space]Az órákon mindig arra törekszünk, hogy már a legkisebbek is értsék, amit csinálnak . A mozgást nem utánozni kell a gyerekeknek, hanem tanulni. Ha tudják, hogy mikor végzik helyesen, akkor nagyobb örömet okoz, ha ez sikerül nekik. A sikerélmény pedig további tanulásra ösztönzi a gyereket, így a figyelmük hosszú időn keresztül fenntartható.[space]A Berczik módszer fontos  alapelve a mozdulatok elemekre bontása és  azok egymástól független kidolgozása, ami ezért pontosságra is nevel. Alkalmazza a sokirányú ráhatás elvét is, ami ugyanannak a testképző feladatnak a különböző testhelyzetekben történő végrehajtását jelenti. Az állandóan változó helyzetek segítik a tudás elmélyítését azáltal, hogy nem válik rutinná a gyakorlás. A Berczik gimnasztika nem kíván speciális fizikai adottságokat, az adott testi lehetőségeken belül mindenkit fejleszt, így mindenkinek sikerélményt ad.[space]A  Berczik-technika nem egy szigorú, zárt rendszer, bármilyen mozgás megengedett, ami esztétikus. Ez nem mond ellent a precizitásra való törekvésnek, mert minden újító mozdulatnak pontosan leírhatónak, ezáltal reprodukálhatónak kell lenni. A fenti keretek között végzett gyakorlás  felébreszti a gyerekekben az alkotás iránti vágyat és maguk is kreatívan bekapcsolódnak a munkába[space]A Berczik gimnasztika szívesen használ eszközöket, ezeknek kettős funkciója van. A kéziszer egyrészt, a test meghosszabbításaként segit megérteni, vizualizálni az irányokat, síkokat. Ugyanakkor változatosabbá teszi a gimnasztikát és mivel bármilyek eszköz használata megengedett, újabb teret nyit az alkotó fantáziának.[space]A Berczik-technikán alapuló koreográfiákban a zene nemcsak kisérőeleme a táncnak, hanem annak tartalmát is kiemeli. Ha a koreográfiát a zenével szoros összhangban készítjük el, akkor a zene és a tánc egymás hatását erősítik. Még szebbnek látjuk a táncot és jobban megértjük a zenét. Ezért lett iskolánk mottója:  Mozgásba hozzuk a zenét.[space]Pers Júlia",
      },
      {
      ...
      },
      {
        ...
        title: "Omisk tábor",
        text:
          "Az Óbuda Mozgásművészeti iskola 6-17 évesek számára szervez napközis tábort két turnusban:[space]<ul><li>2020. augusztus 3-7. között a MOMKultban Tanárok: Taylor Jenny, Taylor Esther, Rózsa Réka, Csöngei Barbara, Dávid Luca, Solti Eszter</li><li>2020. augusztus 24-28. között a békásmegyeri Szent József Házban Tanárink: Taylor Jenny, Taylor Esther, Csöngei Barbara, Dávid Luca, Benis Kati, Rácz-Lakatos Lilla, Solti Eszter</li></ul>[space]Két külön korcsoport számára (6-12; 13-17) egy időpontban, de elkülönülő programmal indítunk tábort a két helyszínünkön, ahol napfényes termek és hatalmas park biztosít kiváló terepet arra, hogy a gyermekek önfeledten, hasznosan töltsék a vakációt, és új barátságokat köthessenek.[space]Az öt napos program ára 36.000 Ft, de az Óbuda Mozgásművészeti Iskola növendékeinek kedvezményesen 33.000 Ft, amely napi háromszori étkezést tartalmaz és tánc továbbá kézműves foglalkozásokat foglal magába.[space]Online kérdőív kitöltése után jelentkezésetek a tábor teljes árának átutalása után válik véglegessé, fizetési határidő július 10![space]A befizetésről jelentkezést követő visszaigazoló e-mailünkben küldünk további tájékoztatást.[space]Idén a vírus okozta rendkívüli helyzet miatt a tábor menetrendje némileg eltér a korábbi években megszokottól. Ezzel kapcsolatos információkat részletesen a tábor előtti hetekben küldjük. Természetesen a mindenkori higiéniás feltételeknek megfelelően járunk el.[space]<strong>Gyermek turnus programja:</strong>[space]A tábor minden reggel 9-kor kezdődik, érkezni 8 órától lehet, reggeli tornával és csapatépítéssel kezdjük a programot. A nap során a gyerekeknek művészi torna és kéziszer órákat tartunk, koreográfiákat tanulnak valamint szabad tánc és kézműves foglalkozásokon vesznek részt. Délután nyújtással zárjuk 16:30-kor a programot. A hetet pedig egy nyilvános bemutatóval fejezzük be.[space]<strong>Ifjúsági turnus programja:</strong>[space]Különböző típusú órákon vesznek részt: mozdulatművészet és modern technikai alapok, kéziszer, előadói és improvizációs készségek fejlesztése, koreográfiatanulás, nyújtás. A délelőtt során két foglalkozás lesz, közte tízórai szünet, ebéd után kis pihenés és kézműves foglalkozás után egy hosszabb órával és nyújtással fejezzük be a napot. A foglalkozások minden nap 9 órától 16:30-ig tartanak.[space]További információkkal a tábor indulása előtt jelentkezünk, addig is bármilyen kérdéssel kapcsolatban keress nyugodtan az elérhetőségeinken.[space]Reméljük, velünk tartotok nyári programjainkon!",
      },
      {
        ...
        text:
          "A hagyományos országos táncversenyek a rendkívüli helyzet miatt idén tavasszal elmaradtak. A Táncpedagógusok Országos Szövetsége viszont új versenyt hirdetett, hogy a résztvevőknek ki se kelljen mozdulniuk otthonról. Az I. Országos Online Szólótánc Versenyen iskolánk tizenegy növendéke indult – Bajnok Luca, Banadics Linda, Banadics Villő, Bánkuti Lili, Buday Virág, Kisfaludy Emese, Matlári Nóra, Sájer Adél, Szilágyi Csenge, Tomka Dorottya és Tóth Adrienn. A versenyzőknek megadott zenére kellett önálló koreográfiát készíteni, felvenni videóra, és elküldeni a zsűrinek értékelésre.[space]Büszkék vagyunk rá, hogy növendékeink bár konzultálhattak tanáraikkal, mindannyian önállóan, kreatív módon oldották meg a feladatot – legtöbben most készítették el első koreográfiájukat.[space]Bánkuti Lili produkcióját a zsűri külön dicséretben részesítette. Gratulálunk![space][space]Növendékeink koreográfiáiból összefoglaló itt: <a href='https://www.youtube.com/watch?v=aJbXdmSIkjk' target='_blank' rel='noopener noreferrer'>https://www.youtube.com/watch?v=aJbXdmSIkjk</a>",
      },
      {
      ...
      },
      {
        ...
        text:
          "December 1-én  harmadik alkalommal vettünk részt Művészi Gimnasztika Szövetség hagyományos versenyén. Nagyon jól szerepeltünk, minden csapatunk  arany minősítést szerzett és  az összesített legmagasabb pontszámot is mi kaptuk.[space]<strong>KÁNON</strong> – arany minősítés – koreográfia Pers Júlia – serdülő – művészi gimnasztika szabadon[space]Détári Borbála, Marton Dóra, Matlári Júlia, Matlári Nóra, Mihályi Jázmin, Munkácsi Alíz, Munkácsi Réka, Pék Laura, Sata Emese, Takács Réka[space]<strong>ÖRDÖGLAKAT</strong> – arany minősítés – koreográfia Pers Júlia – ifjúsági – művészi gimnasztika szabadon[space]Banadics Dorottya, Bazsa Edina, Duca Anasztázia, Kiss Emília, Márkus Hanna, Sájer Adél, Stoffán Virág, Tatár Dorottya, Tóth Adrienn, Tóth Petra Lilla[space]<strong>OLVADÁS</strong> – arany minősítés – koreográfia Mády Krisztina – ifjúsági – labda kéziszer[space]Bajnok Luca, Finta Kincső, Horányi Róza, Horváth Luca, Illényi Johanna, Ilyés Hanna, Imre Dorottya, Márkus Adél, Nagy Lilla, Werner Júlia, Werner Mária, Zombori Márta[space]<strong>KÉT VÍZ KÖZÖTT</strong> – arany minősítés – koreográfia Mády Krisztina – felnőtt – szalag kéziszer[space]Bartók Natália, Csillag Emese, Ecseri Katalin, Jakabffy Lili, Márkus Réka, Somfai Réka",
      },
    ],
  },
  operations: [
