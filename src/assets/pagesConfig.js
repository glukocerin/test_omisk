    ...
    cards: [
      {
        ...
        name: "Pers Júlia",
        desc:
          "Állami díjas táncpedagógus,spaceMűvészeti vezető",
        details:
      ...
      },
      {
        ...
        name: "Benis Katalin",
        desc: "Nívódíjas táncpedagógus,spaceMűvészitorna-edző",
        details:
    ...
    cards: [
      {
        ...
        index: "lockdown",
        text:
          "2020. november 11-től iskolánkban is áttértünk az online oktatásra. Ennek részleteiről minden növendékünket e-mailben tájékoztatjuk ezen a héten.spaceVárjuk azokat a növendékeinket is akik a vírusveszély miatt ebben az évben nem kezdtek el járni. Ők régi csoportjukhoz kapcsolódhatnak.spaceKülső jelentkezést is elfogadunk, de ebben az esetben egyeztetni kell Mikusik Márta iskolatitkárral, hogy melyik csoport volna megfelelő.spaceElérhetőségeink:space06-20-946-0848, 06-1-200-0138spaceiroda@omisk.huspaceBízunk benne, hogy hamarosan személyesen is találkozhatunk!spacePers Júliaspaceművészeti vezető",
      },
      {
        ...
        index: "berczik",
        text:
          "Az OMISK-ot ezelőtt 30 évvel azért alapítottuk, hogy a Berczik technikát tanítsuk gyerekeknek. Ahogy tanítványaink  nőttek, velük együtt fejlődött  az iskola is. Sok más műfaj is helyet kapott, de ma is a Berczik-technikát tartjuk a legfontosabb kiindulási pontnak. Az OMISK-ba jelentkező óvodások most is ezzel kezdenek nálunk.spaceA gyermek életének alapeleme a mozgás. Önként és örömmel csinál mindent, ami közel áll természetes mozgás igényéhez és ez megalapozza szellemi-fizikai fejlődését.  A Berczik módszer ebből az ösztönös mozgásból indul ki és alakítja tudatossá. Így az órai gyakorlatok mindig az életkornak megfelelőek, a tudatosság pedig biztos alapokra helyez bármilyen későbbi mozgástanulást.spaceAz órákon mindig arra törekszünk, hogy már a legkisebbek is értsék, amit csinálnak . A mozgást nem utánozni kell a gyerekeknek, hanem tanulni. Ha tudják, hogy mikor végzik helyesen, akkor nagyobb örömet okoz, ha ez sikerül nekik. A sikerélmény pedig további tanulásra ösztönzi a gyereket, így a figyelmük hosszú időn keresztül fenntartható.spaceA Berczik módszer fontos  alapelve a mozdulatok elemekre bontása és  azok egymástól független kidolgozása, ami ezért pontosságra is nevel. Alkalmazza a sokirányú ráhatás elvét is, ami ugyanannak a testképző feladatnak a különböző testhelyzetekben történő végrehajtását jelenti. Az állandóan változó helyzetek segítik a tudás elmélyítését azáltal, hogy nem válik rutinná a gyakorlás. A Berczik gimnasztika nem kíván speciális fizikai adottságokat, az adott testi lehetőségeken belül mindenkit fejleszt, így mindenkinek sikerélményt ad.spaceA  Berczik-technika nem egy szigorú, zárt rendszer, bármilyen mozgás megengedett, ami esztétikus. Ez nem mond ellent a precizitásra való törekvésnek, mert minden újító mozdulatnak pontosan leírhatónak, ezáltal reprodukálhatónak kell lenni. A fenti keretek között végzett gyakorlás  felébreszti a gyerekekben az alkotás iránti vágyat és maguk is kreatívan bekapcsolódnak a munkábaspaceA Berczik gimnasztika szívesen használ eszközöket, ezeknek kettős funkciója van. A kéziszer egyrészt, a test meghosszabbításaként segit megérteni, vizualizálni az irányokat, síkokat. Ugyanakkor változatosabbá teszi a gimnasztikát és mivel bármilyek eszköz használata megengedett, újabb teret nyit az alkotó fantáziának.spaceA Berczik-technikán alapuló koreográfiákban a zene nemcsak kisérőeleme a táncnak, hanem annak tartalmát is kiemeli. Ha a koreográfiát a zenével szoros összhangban készítjük el, akkor a zene és a tánc egymás hatását erősítik. Még szebbnek látjuk a táncot és jobban megértjük a zenét. Ezért lett iskolánk mottója:  Mozgásba hozzuk a zenét.spacePers Júlia",
      },
      {
      ...
      },
      {
        ...
        title: "Omisk tábor",
        text:
          "Az Óbuda Mozgásművészeti iskola 6-17 évesek számára szervez napközis tábort két turnusban:space<ul><li>2020. augusztus 3-7. között a MOMKultban Tanárok: Taylor Jenny, Taylor Esther, Rózsa Réka, Csöngei Barbara, Dávid Luca, Solti Eszter</li><li>2020. augusztus 24-28. között a békásmegyeri Szent József Házban Tanárink: Taylor Jenny, Taylor Esther, Csöngei Barbara, Dávid Luca, Benis Kati, Rácz-Lakatos Lilla, Solti Eszter</li></ul>spaceKét külön korcsoport számára (6-12; 13-17) egy időpontban, de elkülönülő programmal indítunk tábort a két helyszínünkön, ahol napfényes termek és hatalmas park biztosít kiváló terepet arra, hogy a gyermekek önfeledten, hasznosan töltsék a vakációt, és új barátságokat köthessenek.spaceAz öt napos program ára 36.000 Ft, de az Óbuda Mozgásművészeti Iskola növendékeinek kedvezményesen 33.000 Ft, amely napi háromszori étkezést tartalmaz és tánc továbbá kézműves foglalkozásokat foglal magába.spaceOnline kérdőív kitöltése után jelentkezésetek a tábor teljes árának átutalása után válik véglegessé, fizetési határidő július 10!spaceA befizetésről jelentkezést követő visszaigazoló e-mailünkben küldünk további tájékoztatást.spaceIdén a vírus okozta rendkívüli helyzet miatt a tábor menetrendje némileg eltér a korábbi években megszokottól. Ezzel kapcsolatos információkat részletesen a tábor előtti hetekben küldjük. Természetesen a mindenkori higiéniás feltételeknek megfelelően járunk el.space<strong>Gyermek turnus programja:</strong>spaceA tábor minden reggel 9-kor kezdődik, érkezni 8 órától lehet, reggeli tornával és csapatépítéssel kezdjük a programot. A nap során a gyerekeknek művészi torna és kéziszer órákat tartunk, koreográfiákat tanulnak valamint szabad tánc és kézműves foglalkozásokon vesznek részt. Délután nyújtással zárjuk 16:30-kor a programot. A hetet pedig egy nyilvános bemutatóval fejezzük be.space<strong>Ifjúsági turnus programja:</strong>spaceKülönböző típusú órákon vesznek részt: mozdulatművészet és modern technikai alapok, kéziszer, előadói és improvizációs készségek fejlesztése, koreográfiatanulás, nyújtás. A délelőtt során két foglalkozás lesz, közte tízórai szünet, ebéd után kis pihenés és kézműves foglalkozás után egy hosszabb órával és nyújtással fejezzük be a napot. A foglalkozások minden nap 9 órától 16:30-ig tartanak.spaceTovábbi információkkal a tábor indulása előtt jelentkezünk, addig is bármilyen kérdéssel kapcsolatban keress nyugodtan az elérhetőségeinken.spaceReméljük, velünk tartotok nyári programjainkon!",
      },
      {
        ...
        text:
          "A hagyományos országos táncversenyek a rendkívüli helyzet miatt idén tavasszal elmaradtak. A Táncpedagógusok Országos Szövetsége viszont új versenyt hirdetett, hogy a résztvevőknek ki se kelljen mozdulniuk otthonról. Az I. Országos Online Szólótánc Versenyen iskolánk tizenegy növendéke indult – Bajnok Luca, Banadics Linda, Banadics Villő, Bánkuti Lili, Buday Virág, Kisfaludy Emese, Matlári Nóra, Sájer Adél, Szilágyi Csenge, Tomka Dorottya és Tóth Adrienn. A versenyzőknek megadott zenére kellett önálló koreográfiát készíteni, felvenni videóra, és elküldeni a zsűrinek értékelésre.spaceBüszkék vagyunk rá, hogy növendékeink bár konzultálhattak tanáraikkal, mindannyian önállóan, kreatív módon oldották meg a feladatot – legtöbben most készítették el első koreográfiájukat.spaceBánkuti Lili produkcióját a zsűri külön dicséretben részesítette. Gratulálunk!spacespaceNövendékeink koreográfiáiból összefoglaló itt: <a href='https://www.youtube.com/watch?v=aJbXdmSIkjk' target='_blank' rel='noopener noreferrer'>https://www.youtube.com/watch?v=aJbXdmSIkjk</a>",
      },
      {
        ...
        title: "Gála",
        text:
          "Régi produkciók új köntösben – Nosztalgiázhattunk is a 2020-as OMISK GálánspaceMűfaji változatosság, zenei sokszínűség. Ahogy megszokhattuk, az idei és elmúlt évek legsikeresebb koreográfiái kerültek színpadra február 22-én, az Óbudai Kulturális Központban. Az aktuális versenykoreográfiákon felül viszont több régi, klasszikus produkció új szereposztásban, jelenlegi tanítványainkkal került bemutatásra, az egykori előadók – ma már feleségek, anyukák – pedig a közönség soraiból nosztalgiázhattak. Vendégeinknek köszönjük az érdeklődést, növendékeinknek pedig gratulálunk!",
      },
      {
        ...
        text:
          "Vannak olyan koreográfiák, amiket lehetetlen megunni. A sok új, versenyre készült produkció mellett ezeket az örök klasszikusokat is újranézheted a 2020-as OMISK Gálán. Haladó növendékeink az elmúlt évek legsikeresebb koreográfiáit mutatják be gálaműsorunkon. Várunk szeretettel!spaceJegyek előjegyezhetők iskolatitkárunknál.",
      },
      {
        ...
        text:
          "December 1-én  harmadik alkalommal vettünk részt Művészi Gimnasztika Szövetség hagyományos versenyén. Nagyon jól szerepeltünk, minden csapatunk  arany minősítést szerzett és  az összesített legmagasabb pontszámot is mi kaptuk.space<strong>KÁNON</strong> – arany minősítés – koreográfia Pers Júlia – serdülő – művészi gimnasztika szabadonspaceDétári Borbála, Marton Dóra, Matlári Júlia, Matlári Nóra, Mihályi Jázmin, Munkácsi Alíz, Munkácsi Réka, Pék Laura, Sata Emese, Takács Rékaspace<strong>ÖRDÖGLAKAT</strong> – arany minősítés – koreográfia Pers Júlia – ifjúsági – művészi gimnasztika szabadonspaceBanadics Dorottya, Bazsa Edina, Duca Anasztázia, Kiss Emília, Márkus Hanna, Sájer Adél, Stoffán Virág, Tatár Dorottya, Tóth Adrienn, Tóth Petra Lillaspace<strong>OLVADÁS</strong> – arany minősítés – koreográfia Mády Krisztina – ifjúsági – labda kéziszerspaceBajnok Luca, Finta Kincső, Horányi Róza, Horváth Luca, Illényi Johanna, Ilyés Hanna, Imre Dorottya, Márkus Adél, Nagy Lilla, Werner Júlia, Werner Mária, Zombori Mártaspace<strong>KÉT VÍZ KÖZÖTT</strong> – arany minősítés – koreográfia Mády Krisztina – felnőtt – szalag kéziszerspaceBartók Natália, Csillag Emese, Ecseri Katalin, Jakabffy Lili, Márkus Réka, Somfai Réka",
      },
    ],
  },
  operations: [
    ...
    },
    {
      ...
      parentId: 0,
      description:
        "Hetente 2 (esetenként 3) alkalommal tartunk órákat , melyek időtartama az óvodásoknak 45 perc, iskolás kortól 60 vagy 90 perc.spaceAz aktuális órarendet a tanév elején állítjuk össze a beiratkozáson történő egyeztetés után és szeptember közepén hirdetjük ki. A tanév rendjével az iskolai tanításhoz igazodunk, de ősszel és tavasszal nem tartunk szünetet.spaceA Kurzusaink menüpont alatt a kurzusok leírásánál  megtalálod azt, hogy az egyes helyszíneken mely napokon tartunk órákat. Ha a pontos időpontokra vagy kiváncsi vagy azt szeretnéd megtudni, hogy van-e még szabad hely a választott kurzuson, akkor vedd fel a kapcsolatot irodánkkal!",
    },
    {
      id: 2,
      title: "Programok",
      ...
      parentId: 0,
      description:
        "Az első félév végén decemberben vagy januárban nyilvános bemutató  órákat tartunk az addig tanultakból.spaceJúnius elején a  tanévet ünnepélyes vizsgaelőadással zárjuk  az Óbudai Kulturális Központ és a MOM Kulturális Központ szinpadán.spaceTavasszal haladó növendékeink országos táncversenyeken vehetnek részt.spaceNyáron tánctábor szervezünk a MOM Kulturális Központban és a békásmegyeri Szent József Házban.",
    },
    {
      id: 3,
      title: "Tandíj",
      ...
      parentId: 0,
      description:
        "A tandíj összege a helyszíntől és a foglalkozások időtartamától függően 10.000 - 14.700 Ft/hónap heti 2 vagy 3  alkalomra. A pontos összeget a Kurzusok menűpont almenűiben  találod a hasznos információk között.spaceA tandíjat 2 havonta kérjük befizetni a helyszínen iskolatitkárunknak, Mikusik Mártának  az előre meghirdetett napon (erről mindenkit írásban időben tájékoztatunk).spaceTestvérek beíratása esetén engedményt adunk a tandíjból, melynek összege: 2000,- Ft/hó/főspace Az aktuális tandíjat mindig a megtartott órák alapján számítjuk ki, tehát  ha hivatalos ünnep vagy  szünet miatt 8-nál kevesebb alkalommal van óra, akkor arányosan csökkentjük az arra a hónapra eső tandíjat.spaceNéhány alkalmas hiányzást pótolni lehet egy párhuzamos csoport óráján. Huzamosabb idejű és orvosilag igazolt mulasztás esetén  a tandíjból visszatérítést tudunk adni. Erre vonatkozó igényt az iskola vezetőjének címzett e-mailben kérjük bejelenteni ( pers.julia@omisk.hu )! Ha a mulasztott órák száma meghaladja az havi óraszám felét, akkor fél hónapi díjat jóváírunk  a következő befizetéskor.spaceÁtmenetileg lehet heti 1 alkalommal is  járni, ebben az esetben a tandíjból 30% kedvezményt adunk. Hosszabb távon ezt nem javasoljuk, mert a tananyaggal minden órán haladunk. Különösen a második félévben jelent problémát, amikor a koreográfiákat tanuljuk.",
    },
    {
      id: 4,
      ...
      parentId: 0,
      description:
        "A gyakorlóruha a mozgást nem akadályozó praktikus, kényelmes viselet legyen! A cipő műfajonként különböző lehet, ezt célszerű tanárainkkal megbeszélni.spaceGyermek és serdülő  csoportjaink a nyilvános órákon már egyforma öltözetben szerepelnek és ezt viselik az évzárón is. Ezeket a ruhákat és ifjúsági és felnőtt csapataink fellépő ruháit   hagyományosan Joób Adrienne jelmeztervező és kivitelező  készíti csoportjainknak.spaceA művészi tornán használt kéziszereket - az ugrókötelek kivételével - iskolánk biztosítja.",
    },
    {
      id: 5,
      ...
      parentId: 5,
      description:
        "Beiratkozás: augusztus 26. - szeptember 9.spacespaceÓrarend kihirdetés: szeptember 15. spacespaceA tanítás első napja: szeptember 17.spacespaceA tanítás utolsó napja: július 15.spacespaceTéli szünet :  2020. december 22. – 2021. január 4.spacespaceNyilvános órák: 2020. december - 2021. januárspacespaceÉvzáró előadás: Június 6 ( MOM Kulturális Központ )space                            Június 12-13 ( Óbudai Kulturális Központ )",
    },
    {
      id: 6,
