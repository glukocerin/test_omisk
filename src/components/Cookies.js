  ...
  return (
    <div className={`cookies-block ${(closed || localCookies) && "hidden"}`}>
      <div className="first-section">
        <button className="btn close" onClick={() => cloeCookies(true)}>
          &#215;
        </button>
        <label className="size-20 thin">
          A weboldal <strong>sütiket (cookie-kat)</strong> használ, hogy
          biztonságos böngészés mellett a legjobb felhasználói élményt nyújtsa.
        </label>
        <a
          href={Pdf}
          className="link"
