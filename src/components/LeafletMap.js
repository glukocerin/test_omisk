...
export default function LeafletMap(props) {
  const [mapProperty, setPosition] = useState({ position: [47.5342, 19.07] , zoom: 12 });

  return (
    <Map center={ props.props.position || mapProperty.position } zoom={ props.props.zoom || mapProperty.zoom } zoomControl={false}>
      <TileLayer
      ...
      <Marker position={[47.59798, 19.05255]} onclick={() => setPosition({ position: [47.59798, 19.05255], zoom: 18 }) }>
        <Popup>
      ...
      <Marker position={[47.51262, 18.99469]} onclick={() => setPosition({ position: [47.51262, 18.99469], zoom: 18 }) }>
        <Popup>
      ...
      <Marker position={[47.49992,19.068150]} onclick={() => setPosition({ position: [47.49992,19.068150], zoom: 18 }) }>
        <Popup>
