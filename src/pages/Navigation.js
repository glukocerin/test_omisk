  ...
  return (
    <div className={`header background-${props.BackgroundColor} ${props.isHeaderFixed && "fixed"} ${props.activeDot === 1 && 'big'} ${location === '/' && 'text-inverse'}`}>
      ...
      <div className="links">
        ...
        <label className={`plus-sign ${ location.includes("course") && "active" }`}>
        ...
        <label className={`plus-sign programs ${ location.includes("program") && "active" }`}>
        ...
        <Link className={`${ location.includes("blog") && "active" }`} to="/blog">Blog</Link>
